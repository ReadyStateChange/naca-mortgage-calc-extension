...
export const CensusGeocodeResponseSchema = Schema.Struct({
    result: Schema.Struct({
        addressMatches: Schema.Array(Schema.Struct({
            geographies: Schema.Struct({
                "Census Tracts": Schema.Array(Schema.Struct({
...
export const decodeCensusGeocodeResponse = Schema.decodeUnknownEither(CensusGeocodeResponseSchema);
