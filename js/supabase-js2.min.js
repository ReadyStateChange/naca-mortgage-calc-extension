 ...
 * Original file: /npm/@supabase/supabase-js@2.49.4/dist/umd/supabase.js
 *
  ...
  (() => {
      ...
      i = {
        334: (e, t, r) => {
          r.r(t),
            r.d(t, {
              ...
              AuthClient: () => pe,
              AuthError: () => l,
              AuthImplicitGrantRedirectError: () => _,
              AuthInvalidCredentialsError: () => m,
              AuthInvalidJwtError: () => j,
              AuthInvalidTokenResponseError: () => y,
              AuthPKCEGrantCodeExchangeError: () => b,
              AuthRetryableFetchError: () => k,
              AuthSessionMissingError: () => g,
              AuthUnknownError: () => f,
              AuthWeakPasswordError: () => S,
              CustomAuthError: () => p,
              GoTrueAdminApi: () => se,
              GoTrueClient: () => de,
              NavigatorLockAcquireTimeoutError: () => ce,
              isAuthApiError: () => d,
              isAuthError: () => h,
              isAuthImplicitGrantRedirectError: () => w,
              isAuthRetryableFetchError: () => T,
          ...
          const s = "2.69.1",
            ...
            c = /^([a-z0-9_-]{4})*($|[a-z0-9_-]{3}$|[a-z0-9_-]{2}$)$/i;
          ...
          function $(e, t, r) {
            ...
            for (
              t.queue = t.queue << 6 | s, t.queuedBits += 6; t.queuedBits >= 8;
          ...
          function R(e) {
            ...
            for (let t = 0; t < e.length; t += 1) $(e.charCodeAt(t), r, s);
          ...
          const I = () =>
            ...
            D = (e) => {
              let t;
              return t = e || ("undefined" == typeof fetch
                ? (...e) =>
                  Promise.resolve().then(r.bind(r, 907)).then(
                    ({ default: t }) => t(...e),
                  )
                : fetch),
                (...e) => t(...e);
            ...
            N = (e) =>
              "object" == typeof e && null !== e && "status" in e &&
              "ok" in e && "json" in e && "function" == typeof e.json,
            F = async (e, t, r) => {
          ...
          class q {
            constructor() {
              this.promise = new q.promiseConstructor((e, t) => {
          ...
          function J(e) {
            ...
            for (let e = 0; e < t.length; e++) {
              if (!c.test(t[e])) throw new j("JWT not in base64url format");
            }
            return {
              header: JSON.parse(C(t[0])),
              payload: JSON.parse(C(t[1])),
              signature: R(t[2]),
          ...
          async function z(e, t, r = !1) {
            const s = function () {
              ...
              return crypto.getRandomValues(e), Array.from(e, H).join("");
            }();
            let i = s;
            r && (i += "/PASSWORD_RECOVERY"),
              await F(e, `${t}-code-verifier`, i);
            const n = await async function (e) {
              if (
                "undefined" == typeof crypto || void 0 === crypto.subtle ||
          ...
          q.promiseConstructor = Promise;
          const G =
            /^2[0-9]{3}-(0[1-9]|1[0-2])-(0[1-9]|1[0-9]|2[0-9]|3[0-1])$/i;
          const K = (e) =>
              e.msg || e.message || e.error_description || e.error ||
              JSON.stringify(e),
            W = [502, 503, 504];
          async function V(e) {
            var t;
            if (!N(e)) throw new k(K(e), 0);
            if (W.includes(e.status)) throw new k(K(e), e.status);
            let r, s;
            try {
              r = await e.json();
            } catch (e) {
            ...
            if (
              i && i.getTime() >= a["2024-01-01"].timestamp &&
                "object" == typeof r && r && "string" == typeof r.code
                ? s = r.code
                : "object" == typeof r && r &&
                  "string" == typeof r.error_code && (s = r.error_code),
                s
            ) {
              if ("weak_password" === s) {
                throw new S(
              ...
              if ("session_not_found" === s) throw new g();
            } else if (
              "object" == typeof r && r && "object" == typeof r.weak_password &&
              r.weak_password && Array.isArray(r.weak_password.reasons) &&
              r.weak_password.reasons.length &&
              r.weak_password.reasons.reduce((e, t) =>
                e && "string" == typeof t, !0)
            ) throw new S(K(r), e.status, r.weak_password.reasons);
            throw new u(K(r), e.status || 500, s);
          }
          async function Y(e, t, r, s) {
            ...
            (null == s ? void 0 : s.redirectTo) &&
              (c.redirect_to = s.redirectTo);
            const l = Object.keys(c).length
                ? "?" + new URLSearchParams(c).toString()
                : "",
              h = await async function (e, t, r, s, i, n) {
                const o = ((e, t, r, s) => {
                  const i = {
                    method: e,
                ...
                try {
                  ...
                  throw console.error(e), new k(K(e), 0);
                }
                if (
                  a.ok || await V(a), null == s ? void 0 : s.noResolveJson
                ) return a;
                try {
                  return await a.json();
                } catch (e) {
          ...
          function X(e) {
            const t = Q(e);
            return !t.error && e.weak_password &&
              "object" == typeof e.weak_password &&
              Array.isArray(e.weak_password.reasons) &&
              e.weak_password.reasons.length && e.weak_password.message &&
          ...
          function te(e) {
            const {
              ...
              o = function (e, t) {
                ...
                if (
                  null != e && "function" == typeof Object.getOwnPropertySymbols
                ) {
                  var i = 0;
                  for (
                    s = Object.getOwnPropertySymbols(e); i < s.length; i++
                  ) {t.indexOf(s[i]) < 0 &&
            ...
            async listUsers(e) {
              ...
              try {
                const c = { nextPage: null, lastPage: 0, total: 0 },
                  l = await Y(this.fetch, "GET", `${this.url}/admin/users`, {
                    headers: this.headers,
                    noResolveJson: !0,
                    query: {
                      page:
            ...
            async updateUserById(e, t) {
              try {
                return await Y(
                  ...
                  "PUT",
                  `${this.url}/admin/users/${e}`,
                  { body: t, headers: this.headers, xform: Z },
                );
              } catch (e) {
                if (h(e)) return { data: { user: null }, error: e };
                throw e;
          ...
          const oe = {
            debug:
              !!(globalThis && U() && globalThis.localStorage &&
                "true" ===
          ...
          class de {
            constructor(e) {
              ...
              this.memoryStorage = null,
                ...
                this.instanceID = de.nextInstanceID,
                de.nextInstanceID += 1,
                this.instanceID > 0 && I() &&
                console.warn(
                  "Multiple GoTrueClient instances detected in the same browser context. It is not an error, but this should be avoided as it may produce undefined behavior when used concurrently under the same storage key.",
                );
              const s = Object.assign(Object.assign({}, he), e);
              if (
                this.logDebugMessages = !!s.debug,
                  ...
                  this.mfa = {
                    ...
                    getAuthenticatorAssuranceLevel: this
                      ._getAuthenticatorAssuranceLevel.bind(this),
                  },
                  this.persistSession
                    ? s.storage
                      ...
                      ? this.storage = ie
                      : (this.memoryStorage = {},
                        this.storage = ne(this.memoryStorage))
                    : (this.memoryStorage = {},
                      this.storage = ne(this.memoryStorage)),
                  I() && globalThis.BroadcastChannel && this.persistSession &&
                  this.storageKey
              ) {
                try {
                ...
                null === (r = this.broadcastChannel) || void 0 === r ||
            ...
            _debug(...e) {
              return this.logDebugMessages &&
                this.logger(
                  `GoTrueClient@${this.instanceID} (${s}) ${
              ...
              try {
                ...
                if (
                  this._isImplicitGrantCallback(t)
                    ...
                    I() && this.detectSessionInUrl && "none" !== r
                ) {
                  const { data: s, error: i } = await this._getSessionFromURL(
                    t,
                    r,
                  );
                  if (i) {
                    if (
                      ...
                      const t = null === (e = i.details) || void 0 === e
                        ? void 0
                        : e.code;
                      if (
            ...
            async signInAnonymously(e) {
              var t, r, s;
              try {
                const i = await Y(this.fetch, "POST", `${this.url}/signup`, {
                    headers: this.headers,
                    body: {
                      data:
                        null !==
            ...
            async signUp(e) {
              ...
              try {
                ...
                if ("email" in e) {
                  ...
                  let o = null, a = null;
                  "pkce" === this.flowType &&
                  ([o, a] = await z(this.storage, this.storageKey)),
                    i = await Y(this.fetch, "POST", `${this.url}/signup`, {
                      headers: this.headers,
            ...
            async signInWithOAuth(e) {
              ...
              return await this._handleProviderSignIn(e.provider, {
                redirectTo: null === (t = e.options) || void 0 === t
                  ? void 0
                  : t.redirectTo,
                scopes: null === (r = e.options) || void 0 === r
                  ? void 0
                  : r.scopes,
                queryParams: null === (s = e.options) || void 0 === s
                  ? void 0
                  : s.queryParams,
                skipBrowserRedirect: null === (i = e.options) || void 0 === i
                  ? void 0
            ...
            async exchangeCodeForSession(e) {
              return await this.initializePromise,
                this._acquireLock(
                  -1,
                  async () => this._exchangeCodeForSession(e),
                );
            }
            async _exchangeCodeForSession(e) {
              ...
              try {
                ...
                if (
                  await B(this.storage, `${this.storageKey}-code-verifier`), i
                ) throw i;
            ...
            async verifyOtp(e) {
              ...
              try {
                let s, i;
                "options" in e && (s = null === (t = e.options) || void 0 === t
                  ? void 0
                  : t.redirectTo,
                  i = null === (r = e.options) || void 0 === r
                    ? void 0
                    : r.captchaToken);
                const { data: n, error: o } = await Y(
                  this.fetch,
                  "POST",
                  `${this.url}/verify`,
                  {
                ...
                const a = n.session, c = n.user;
                return (null == a ? void 0 : a.access_token) &&
            ...
            async signInWithSSO(e) {
              ...
              try {
                let i = null, n = null;
                return "pkce" === this.flowType &&
                  ([i, n] = await z(this.storage, this.storageKey)),
              ...
              try {
                ...
                if ("email" in e) {
                  const { email: r, type: s, options: i } = e,
                    { error: n } = await Y(this.fetch, "POST", t, {
                      headers: this.headers,
                      body: {
                        email: r,
                        type: s,
                ...
                if ("phone" in e) {
                  const { phone: r, type: s, options: i } = e,
                    { data: n, error: o } = await Y(this.fetch, "POST", t, {
                      headers: this.headers,
                      body: {
                        phone: r,
                        type: s,
            ...
            async getSession() {
              return await this.initializePromise,
                await this._acquireLock(
                  -1,
                  async () => this._useSession(async (e) => e),
                );
            }
            ...
            async __loadSession() {
              ...
              try {
                let e = null;
                const t = await M(this.storage, this.storageKey);
                if (
                  this._debug("#getSession()", "session from storage", t),
                    null !== t && (this._isValidSession(t)
                      ? e = t
                      : (this._debug(
                        "#getSession()",
                  ...
                  : await this._useSession(async (e) => {
                    ...
                    return (null === (t = i.session) || void 0 === t
                      ...
                      ? await Y(this.fetch, "GET", `${this.url}/user`, {
                        headers: this.headers,
                        jwt:
                          null !== (s = null === (r = i.session) || void 0 === r
                                ? void 0
            ...
            async _updateUser(e, t = {}) {
              try {
                return await this._useSession(async (r) => {
                  ...
                  if (i) throw i;
                  if (!s.session) throw new g();
                  const n = s.session;
                  let o = null, a = null;
                  "pkce" === this.flowType && null != e.email &&
                    ([o, a] = await z(this.storage, this.storageKey));
                  const { data: c, error: l } = await Y(
                    this.fetch,
                    "PUT",
                    `${this.url}/user`,
                    {
            ...
            async _setSession(e) {
              try {
                ...
                let r = t, s = !0, i = null;
                const { payload: n } = J(e.access_token);
                if (n.exp && (r = n.exp, s = r <= t), s) {
                  ...
                  const { data: s, error: n } = await this._getUser(
                    e.access_token,
                  );
                  if (n) throw n;
                  i = {
            ...
            async _getSessionFromURL(e, t) {
              try {
                if (!I()) throw new _("No browser detected.");
                if (
                  e.error || e.error_description || e.error_code
                ) {throw new _(
                    e.error_description ||
                ...
                switch (t) {
                  case "implicit":
                    if ("pkce" === this.flowType) {throw new b(
                        "Not a valid PKCE flow url.",
                      );}
                    break;
                  case "pkce":
                    if ("implicit" === this.flowType) {throw new _(
                ...
                if ("pkce" === t) {
                  if (
                    this._debug("#_initialize()", "begin", "is PKCE flow", !0),
                      !e.code
                  ) throw new b("No code detected.");
                  const { data: t, error: r } = await this
                    ._exchangeCodeForSession(e.code);
                  if (r) throw r;
            ...
            async _signOut({ scope: e } = { scope: "global" }) {
              return await this._useSession(async (t) => {
                ...
                const { data: s, error: i } = t;
                if (i) return { error: i };
                const n = null === (r = s.session) || void 0 === r
                  ? void 0
                  : r.access_token;
                if (n) {
            ...
            async resetPasswordForEmail(e, t = {}) {
              let r = null, s = null;
              "pkce" === this.flowType &&
                ([r, s] = await z(this.storage, this.storageKey, !0));
              try {
            ...
            async getUserIdentities() {
              ...
              try {
                ...
                return {
                  data: {
                    identities: null !== (e = t.user.identities) && void 0 !== e
                      ? e
                      : [],
                  },
                  error: null,
            ...
            async linkIdentity(e) {
              ...
              try {
                const { data: r, error: s } = await this._useSession(
                  async (t) => {
                    ...
                    const l = await this._getUrlForProvider(
                      ...
                      e.provider,
                      {
                        redirectTo: null === (r = e.options) || void 0 === r
                          ? void 0
                          : r.redirectTo,
                        scopes: null === (s = e.options) || void 0 === s
                          ? void 0
                          : s.scopes,
                        queryParams: null === (i = e.options) || void 0 === i
                          ? void 0
                          : i.queryParams,
                        skipBrowserRedirect: !0,
                      },
                    );
                    return await Y(this.fetch, "GET", l, {
                      headers: this.headers,
                      jwt:
                        null !== (o = null === (n = a.session) || void 0 === n
                              ? void 0
                ...
                if (s) throw s;
                return I() && !(null === (t = e.options) || void 0 === t
                  ? void 0
            ...
            async _refreshAccessToken(e) {
              ...
              try {
                ...
                if (this._debug(t, "error", e), h(e)) {return {
                    data: { session: null, user: null },
                    error: e,
                  };}
                throw e;
            ...
            _isValidSession(e) {
              return "object" == typeof e && null !== e &&
                "access_token" in e && "refresh_token" in e &&
                "expires_at" in e;
            }
            ...
            async _recoverAndRefresh() {
              ...
              this._debug(t, "begin");
              try {
                const r = await M(this.storage, this.storageKey);
                if (
                  this._debug(t, "session from storage", r),
                    !this._isValidSession(r)
                ) {return this._debug(t, "session is not valid"),
                    void (null !== r && await this._removeSession());}
                const s = 1e3 * (null !== (e = r.expires_at) && void 0 !== e
                          ? e
                          : 1 / 0) - Date.now() < 9e4;
                if (
                  this._debug(
            ...
            async _callRefreshToken(e) {
              var t, r;
              if (!e) throw new g();
              if (this.refreshingDeferred) {return this.refreshingDeferred
                  .promise;}
              const s = `#_callRefreshToken(${e.substring(0, 5)}...)`;
              this._debug(s, "begin");
              try {
                this.refreshingDeferred = new q();
                ...
                if (this._debug(s, "error", e), h(e)) {
                  const r = { session: null, error: e };
                  return T(e) || await this._removeSession(),
                    null === (t = this.refreshingDeferred) || void 0 === t ||
                    t.resolve(r),
                    r;
                }
                throw null === (r = this.refreshingDeferred) || void 0 === r ||
                  r.reject(e),
                  e;
              } finally {
              ...
              this.autoRefreshTicker = e,
                e && "object" == typeof e && "function" == typeof e.unref
                  ...
                  : "undefined" != typeof Deno &&
                    "function" == typeof Deno.unrefTimer && Deno.unrefTimer(e),
                setTimeout(async () => {
                  await this.initializePromise,
            ...
            async _autoRefreshTokenTick() {
              ...
              try {
                  ...
                  try {
                    ...
                    try {
                      return await this._useSession(async (t) => {
                        ...
                        if (
                          !r || !r.refresh_token || !r.expires_at
                        ) {
                        ...
                        const s = Math.floor((1e3 * r.expires_at - e) / i);
                        this._debug(
                          "#_autoRefreshTokenTick()",
                ...
                if (!(e.isAcquireTimeout || e instanceof ae)) throw e;
              ...
              this._debug(t, "visibilityState", document.visibilityState),
                "visible" === document.visibilityState
                  ...
                  : "hidden" === document.visibilityState &&
                    this.autoRefreshToken && this._stopAutoRefresh();
            }
            async _getUrlForProvider(e, t, r) {
              ...
              if (
                ...
                const [e, t] = await z(this.storage, this.storageKey),
              ...
              return (null == r ? void 0 : r.skipBrowserRedirect) &&
                  ...
                  return c
                    ...
                    : ("totp" === e.factorType &&
                      (null === (s = null == a ? void 0 : a.totp) ||
                        ...
                        : s.qr_code) &&
                      (a.totp.qr_code =
                        `data:image/svg+xml;utf-8,${a.totp.qr_code}`),
                      { data: a, error: null });
                });
              } catch (e) {
                if (h(e)) return { data: null, error: e };
                  ...
                  return await this._useSession(async (t) => {
                    ...
                    return o
                      ...
                      : (await this._saveSession(
                        Object.assign({
                          expires_at: Math.round(Date.now() / 1e3) +
                            n.expires_in,
                        }, n),
                      ),
                        await this._notifyAllSubscribers(
            ...
            async _getAuthenticatorAssuranceLevel() {
              return this._acquireLock(-1, async () =>
                await this._useSession(async (e) => {
                  ...
                  const { payload: n } = J(s.access_token);
                  let o = null;
                  n.aal && (o = n.aal);
                  let a = o;
                  return (null !==
                            (r = null === (t = s.user.factors) || void 0 === t
                              ? void 0
            ...
            async fetchJwk(e, t = { keys: [] }) {
              ...
              if (i) throw i;
              if (!s.keys || 0 === s.keys.length) throw new j("JWKS is empty");
              if (
                this.jwks = s,
                  this.jwks_cached_at = Date.now(),
                  r = s.keys.find((t) => t.kid === e),
                  !r
              ) throw new j("No matching signing key found in JWKS");
              return r;
            }
              ...
              try {
                ...
                if (
                  function (e) {
                    ...
                    if (e <= Math.floor(Date.now() / 1e3)) {throw new Error(
                        "JWT has expired",
                      );}
                  }(i.exp),
                    !s.kid || "HS256" === s.alg || !("crypto" in globalThis) ||
                    !("subtle" in globalThis.crypto)
                ) {
                  const { error: e } = await this.getUser(r);
                  if (e) throw e;
                  return {
                    data: { claims: i, header: s, signature: n },
                    error: null,
                  };
                }
                const c = function (e) {
                      ...
                      return function (e, t) {
                        for (let r = 0; r < e.length; r += 1) {
                          ...
                          if (s > 55295 && s <= 56319) {
                            ...
                            s = 65536 +
                              (e.charCodeAt(r + 1) - 56320 & 65535 | t), r += 1;
                          }
                          x(s, t);
                        }
                      }(e, (e) => t.push(e)),
        ...
        227: (e, t, r) => {
          ...
          class c {
            constructor(
              e,
              { headers: t = {}, customFetch: s, region: i = a.Any } = {},
            ) {
              this.url = e,
                this.headers = t,
                this.region = i,
            ...
            invoke(e, t = {}) {
              ...
              return s = this,
                ...
                l = function* () {
                  try {
                    const { headers: s, method: a, body: c } = t;
                    let l, h = {}, { region: u } = t;
                    u || (u = this.region),
                    ...
                    let p,
                      g =
                        (null !== (r = d.headers.get("Content-Type")) &&
                            void 0 !== r
                          ? r
                          : "text/plain").split(";")[0].trim();
                    return p = "application/json" === g
                      ? yield d.json()
                ...
                new ((c = void 0) || (c = Promise))(function (e, t) {
                  ...
                  function n(t) {
                    ...
                    t.done
                      ? e(t.value)
                      : (s = t.value,
                        s instanceof c ? s : new c(function (e) {
                          e(s);
                        })).then(r, i);
                  }
        ...
        660: function (e, t, r) {
          ...
          t.default = class {
            ...
            then(e, t) {
              void 0 === this.schema || (["GET", "HEAD"].includes(this.method)
              ...
              let r = (0, this.fetch)(this.url.toString(), {
                ...
                if (e.ok) {
                  ...
                  const s = null === (t = this.headers.Prefer) || void 0 === t
                      ? void 0
                  ...
                  s && n && n.length > 1 && (a = parseInt(n[1])),
                    this.isMaybeSingle && "GET" === this.method &&
                    Array.isArray(o) && (o.length > 1
                      ? (i = {
                        code: "PGRST116",
                        details:
                          `Results contain ${o.length} rows, application/vnd.pgrst.object+json requires 1 row`,
                        hint: null,
                        message:
        ...
        961: function (e, t, r) {
          ...
          Object.defineProperty(t, "__esModule", { value: !0 });
          const i = s(r(45)), n = s(r(825)), o = r(530);
          class a {
            ...
            rpc(e, t = {}, { head: r = !1, get: s = !1, count: i } = {}) {
              ...
              r || s
                ? (o = r ? "HEAD" : "GET",
                  Object.entries(t).filter(([e, t]) => void 0 !== t).map(
                    (
                      [e, t],
                    ) => [e, Array.isArray(t) ? `{${t.join(",")}}` : `${t}`],
                  ).forEach(([e, t]) => {
                    a.searchParams.append(e, t);
                  }))
                : (o = "POST", c = t);
              const l = Object.assign({}, this.headers);
              return i && (l.Prefer = `count=${i}`),
                new n.default({
                  method: o,
                  url: a,
                  headers: l,
        ...
        825: function (e, t, r) {
          ...
          class n extends i.default {
            ...
            likeAllOf(e, t) {
              return this.url.searchParams.append(
                e,
                `like(all).{${t.join(",")}}`,
              ),
                this;
        ...
        45: function (e, t, r) {
          ...
          t.default = class {
            ...
            select(e, { head: t = !1, count: r } = {}) {
              const s = t ? "HEAD" : "GET";
              let n = !1;
              const o = (null != e ? e : "*").split("").map(
                (e) => /\s/.test(e) && !n ? "" : ('"' === e && (n = !n), e),
              ).join("");
            ...
            upsert(
              ...
              const o = [`resolution=${r ? "ignore" : "merge"}-duplicates`];
              if (
        ...
        261: function (e, t, r) {
          ...
          class n extends i.default {
            select(e) {
              let t = !1;
              const r = (null != e ? e : "*").split("").map(
                (e) => /\s/.test(e) && !t ? "" : ('"' === e && (t = !t), e),
              ).join("");
            ...
            explain(
              ...
              const a = [
                ...
                c = null !== (o = this.headers.Accept) && void 0 !== o
                  ? o
                  : "application/json";
            ...
            rollback() {
              var e;
              return (null !== (e = this.headers.Prefer) && void 0 !== e
                  ? e
                  : "").trim().length > 0
        ...
        932: (e, t, r) => {
          ...
          const s = { "X-Client-Info": "realtime-js/2.11.2" };
          var i, n, o, a, c, l;
          !function (e) {
          ...
          const d = (e, t, r = {}) => {
            ...
            f = (e, t, r, s) => {
              const i = t.find((t) => t.name === e),
                ...
                o = r[e];
              return n && !s.includes(n) ? p(n, o) : g(o);
            },
            p = (e, t) => {
              if ("_" === e.charAt(0)) {
          ...
          class k {
            ...
            _matchReceive({ status: e, response: t }) {
              this.recHooks.filter((t) => t.status === e).forEach(
                (e) => e.callback(t),
              );
            }
            _hasReceived(e) {
            ...
            static transformState(e) {
              return e = this.cloneDeep(e),
                Object.getOwnPropertyNames(e).reduce((t, r) => {
                  const s = e[r];
                  return t[r] = "metas" in s
                    ? s.metas.map(
                      (e) => (e.presence_ref = e.phx_ref,
                        delete e.phx_ref,
          ...
          class A {
            ...
            subscribe(e, t = this.timeout) {
              ...
              {
                const { config: { broadcast: i, presence: n, private: o } } =
                  this.params;
                this._onError(
                  (t) => null == e ? void 0 : e(j.CHANNEL_ERROR, t),
                ...
                (a.access_token = this.socket.accessTokenValue),
                  ...
                  this.joinedOnce = !0,
                  this._rejoin(t),
                  this.joinPush.receive(
                    "ok",
                    async ({ postgres_changes: t }) => {
                      var r;
                      if (this.socket.setAuth(), void 0 !== t) {
                        ...
                        for (let r = 0; r < i; r++) {
                          const i = s[r],
                            ...
                            h = t && t[r];
                          if (
                            !h || h.event !== o || h.schema !== a ||
                            h.table !== c || h.filter !== l
                          ) {
                        ...
                        return this.bindings.postgres_changes = n,
            ...
            async send(e, t = {}) {
              var r, s;
              if (
                this._canPush() || "broadcast" !== e.type
              ) {
              ...
              }
              {
                ...
                try {
                  ...
                  return await (null === (s = e.body) || void 0 === s
                    ? void 0
                    : s.cancel()),
                    e.ok ? "ok" : "error";
                } catch (e) {
            ...
            _trigger(e, t, r) {
              ...
              if (
                r && [a, c, l, h].indexOf(n) >= 0 && r !== this._joinRef()
              ) return;
              ...
              ["insert", "update", "delete"].includes(n)
                ? null === (s = this.bindings.postgres_changes) ||
                  void 0 === s || s.filter((e) => {
                    var t, r, s;
                    return "*" === (null === (t = e.filter) || void 0 === t
                          ? void 0
                          : t.event) ||
                      (null === (s = null === (r = e.filter) || void 0 === r
                                ? void 0
                                : r.event) || void 0 === s
                          ? void 0
                          : s.toLocaleLowerCase()) === n;
                  }).map((e) => e.callback(u, r))
                : null === (i = this.bindings[n]) || void 0 === i ||
                  i.filter((e) => {
                    var r, s, i, o, a, c;
                    if (
                      ...
                      if ("id" in e) {
                        const n = e.id,
                          o = null === (r = e.filter) || void 0 === r
                            ? void 0
                            : r.event;
                        return n && (null === (s = t.ids) || void 0 === s
                          ? void 0
                          : s.includes(n)) &&
                          ("*" === o ||
            ...
            _off(e, t) {
              ...
              return this.bindings[r] = this.bindings[r].filter((e) => {
                var s;
                return !((null === (s = e.type) || void 0 === s
                      ? void 0
                      : s.toLocaleLowerCase()) === r && A.isEqual(e.filter, t));
              }),
                this;
            }
            static isEqual(e, t) {
            ...
            _getPayloadRecords(e) {
              const t = { new: {}, old: {} };
              return "INSERT" !== e.type && "UPDATE" !== e.type ||
          ...
          class x {
            ...
            connect() {
              if (!this.conn) {
                if (this.transport) {this.conn = new this.transport(
                    this.endpointURL(),
                    void 0,
                    { headers: this.headers },
                  );} else {
                  if (C) {return this.conn = new WebSocket(this.endpointURL()),
                  ...
                  this.conn = new R(this.endpointURL(), void 0, {
                    ...
                    r.e(591).then(r.t.bind(r, 591, 23)).then(
                      ({ default: e }) => {
            ...
            channel(e, t = { config: {} }) {
              const r = new A(`realtime:${e}`, t, this);
            ...
            async setAuth(e = null) {
              let t = e || this.accessToken && await this.accessToken() ||
              ...
              if (t) {
                ...
                if (
                  e && e.exp && !(Math.floor(Date.now() / 1e3) - e.exp < 0)
                ) {return this.log(
                    "auth",
            ...
            async sendHeartbeat() {
              var e;
              if (this.isConnected()) {
                if (this.pendingHeartbeatRef) {return this.pendingHeartbeatRef =
                    null,
                    this.log(
                      "transport",
                      "heartbeat timeout. Attempting to re-establish connection",
                    ),
                    void (null === (e = this.conn) || void 0 === e ||
            ...
            _onConnMessage(e) {
              this.decode(e.data, (e) => {
                ...
                (this.pendingHeartbeatRef = null),
                  ...
                  this.channels.filter((e) => e._isMember(t)).forEach(
                    (e) => e._trigger(r, s, i),
                  ),
            ...
            async _onConnOpen() {
              ...
              } else {this.heartbeatTimer && clearInterval(this.heartbeatTimer),
                ...
                const i = yield (a = void 0,
                  ...
                  u = function* () {
                    return "undefined" == typeof Response
                      ? (yield Promise.resolve().then(r.bind(r, 907))).Response
                      : Response;
                  },
                  new (l || (l = Promise))(function (e, t) {
                    ...
                    function i(t) {
                      ...
                      t.done
                        ? e(t.value)
                        : (i = t.value,
                          i instanceof l ? i : new l(function (e) {
                            e(i);
                          })).then(r, s);
                    }
          ...
          function f(e, t, r, s, i, n) {
            return l(this, void 0, void 0, function* () {
              return new Promise((o, a) => {
                e(r, d(t, s, i, n)).then((e) => {
                  if (!e.ok) throw e;
                  return (null == s ? void 0 : s.noResolveJson) ? e : e.json();
                }).then((e) => o(e)).catch((e) => u(e, a, s));
              });
            });
          }
          function p(e, t, r, s) {
          ...
          class w {
            ...
            uploadOrUpdate(e, t, r, s) {
              return y(this, void 0, void 0, function* () {
                try {
                  let i;
                  const n = Object.assign(Object.assign({}, _), s);
                  let o = Object.assign(
                    Object.assign({}, this.headers),
            ...
            uploadToSignedUrl(e, t, r, s) {
              return y(this, void 0, void 0, function* () {
                ...
                try {
                  let e;
                  const t = Object.assign({ upsert: _.upsert }, s),
            ...
            createSignedUploadUrl(e, t) {
              return y(this, void 0, void 0, function* () {
                try {
                  ...
                  if (!a) throw new s("No token returned by API");
                  return {
            ...
            move(e, t, r) {
              return y(this, void 0, void 0, function* () {
                try {
                  return {
                    data: yield g(this.fetch, `${this.url}/object/move`, {
                      bucketId: this.bucketId,
                      sourceKey: e,
                      destinationKey: t,
                      destinationBucket: null == r
                        ? void 0
                        : r.destinationBucket,
                    }, { headers: this.headers }),
                    error: null,
              ...
              return y(this, void 0, void 0, function* () {
                try {
                  return {
                    data: {
                      path:
                        (yield g(this.fetch, `${this.url}/object/copy`, {
                          bucketId: this.bucketId,
                          sourceKey: e,
                          destinationKey: t,
                          destinationBucket: null == r
            ...
            download(e, t) {
              return y(this, void 0, void 0, function* () {
                const r = void 0 !== (null == t ? void 0 : t.transform)
              ...
              return y(this, void 0, void 0, function* () {
                ...
                try {
                  ...
                  if (i(e) && e instanceof o) {
                    ...
                    if (
                      [400, 404].includes(null == t ? void 0 : t.status)
            ...
            getPublicUrl(e, t) {
              const r = this._getFinalPath(e),
                ...
                i = (null == t ? void 0 : t.download)
                  ...
                  : "";
              "" !== i && s.push(i);
              const n = void 0 !== (null == t ? void 0 : t.transform)
                  ? "render/image"
                  : "object",
          ...
          class T {
            ...
            createBucket(e, t = { public: !1 }) {
              return k(this, void 0, void 0, function* () {
                try {
                  return {
                    data: yield g(this.fetch, `${this.url}/bucket`, {
                      id: e,
                      name: e,
                      public: t.public,
            ...
            updateBucket(e, t) {
              return k(this, void 0, void 0, function* () {
                try {
                  const r = yield function (e, t, r, s) {
                    return l(this, void 0, void 0, function* () {
            ...
            deleteBucket(e) {
              return k(this, void 0, void 0, function* () {
                try {
                  return {
                    data: yield v(this.fetch, `${this.url}/bucket/${e}`, {}, {
                      headers: this.headers,
                    }),
                    error: null,
                  };
          ...
          t.default = class {
            constructor(e, t, r) {
              ...
              const u = `sb-${
                ...
                f = (0, h.applySettingDefaults)(null != r ? r : {}, d);
              this.storageKey = null !== (s = f.auth.storageKey) && void 0 !== s
                ? s
                : "",
                this.headers = null !== (i = f.global.headers) && void 0 !== i
                  ? i
                  : {},
                f.accessToken
                  ? (this.accessToken = f.accessToken,
                    this.auth = new Proxy({}, {
                      get: (e, t) => {
                        throw new Error(
                          `@supabase/supabase-js: Supabase Client is configured with the accessToken option, accessing supabase.auth.${
                            String(t)
                          } is not possible`,
                        );
                      },
            ...
            _getAccessToken() {
              ...
              return s(this, void 0, void 0, function* () {
                ...
                return null !== (t = null === (e = r.session) || void 0 === e
                        ? void 0
        ...
        440: function (e, t, r) {
          var s = this && this.__createBinding || (Object.create
              ? function (e, t, r, s) {
                void 0 === s && (s = r);
        ...
        985: (e, t, r) => {
          ...
          i = "undefined" != typeof Deno
            ...
            : "node",
            t.DEFAULT_HEADERS = {
              "X-Client-Info": `supabase-js-${i}/${s.version}`,
            },
        ...
        720: function (e, t, r) {
          var s = this && this.__createBinding || (Object.create
            ...
            n = this && this.__importStar || function (e) {
              ...
              var t = {};
              if (null != e) {
                for (var r in e) {"default" !== r &&
                    Object.prototype.hasOwnProperty.call(e, r) && s(t, e, r);}
              }
              return i(t, e), t;
            },
            o = this && this.__awaiter || function (e, t, r, s) {
              return new (r || (r = Promise))(function (i, n) {
                function o(e) {
                  try {
                    c(s.next(e));
          ...
          t.resolveFetch = (e) => {
            let t;
            return t = e || ("undefined" == typeof fetch ? a.default : fetch),
              (...e) => t(...e);
          },
            t.resolveHeadersConstructor = () =>
            ...
            t.fetchWithAuth = (e, r, s) => {
              ...
              return (t, s) => o(void 0, void 0, void 0, function* () {
                var o;
                const a = null !== (o = yield r()) && void 0 !== o ? o : e;
                let c = new n(null == s ? void 0 : s.headers);
                return c.has("apikey") || c.set("apikey", e),
                  c.has("Authorization") ||
                  c.set("Authorization", `Bearer ${a}`),
                  i(t, Object.assign(Object.assign({}, s), { headers: c }));
              });
            };
        },
        793: function (e, t) {
          var r = this && this.__awaiter || function (e, t, r, s) {
            return new (r || (r = Promise))(function (i, n) {
              function o(e) {
                try {
                  c(s.next(e));
          ...
          Object.defineProperty(t, "__esModule", { value: !0 }),
            ...
            t.applySettingDefaults = function (e, t) {
              const { db: s, auth: i, realtime: n, global: o } = e,
                ...
                u = {
                  ...
                  accessToken: () => r(this, void 0, void 0, function* () {
                    return "";
                  }),
                };
              return e.accessToken
                ? u.accessToken = e.accessToken
    ...
    return o.m = i,
      ...
      o.t = function (r, s) {
        ...
        e = e || [null, t({}), t([]), t(t)];
        for (
          var a = 2 & s && r; "object" == typeof a && !~e.indexOf(a); a = t(a)
        ) Object.getOwnPropertyNames(a).forEach((e) => n[e] = () => r[e]);
        return n.default = () => r, o.d(i, n), i;
      },
      o.d = (e, t) => {
        for (var r in t) {o.o(t, r) && !o.o(e, r) &&
          ...
          if (void 0 !== i) {
            for (
              ...
              if (
                ...
                u.getAttribute("data-webpack") == s + i
              ) {
                a = u;
                break;
              }
      ...
      (() => {
        ...
        if (
          ...
          if (r.length) {for (
              var s = r.length - 1; s > -1 && (!e || !/^http(s?):/.test(e));
            ) e = r[s--].src;}
        }
      ...
      (() => {
        ...
        o.f.j = (t, r) => {
          ...
          if (0 !== s) {
            if (s) r.push(s[2]);
              ...
              var i = new Promise((r, i) => s = e[t] = [r, i]);
              r.push(s[2] = i);
              var n = o.p + o.u(t), a = new Error();
              o.l(
                n,
                (r) => {
        ...
        var t = (t, r) => {
            ...
            for (t && t(r); l < n.length; l++) {i = n[l],
                o.o(e, i) && e[i] && e[i][0](),
                e[i] = 0;}
          },
          r = self.webpackChunksupabase = self.webpackChunksupabase || [];
